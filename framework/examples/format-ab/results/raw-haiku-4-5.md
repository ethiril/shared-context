...
[
  {
    ...
    "alternatives_rejected": [
      {
        "option": "Synchronous send from the API",
        "reason": "SES p99 is well above signup-latency budget."
      },
      {
        "option": "Job-status callback to the API",
        "reason": "rejected for v1. No consumer; would only matter once we add retries."
      },
      {
        "option": "Outbox pattern",
        "reason": "overkill until we have a transactional concern we don't have today."
      }
    ],
    "consequences": [
...
| Batch | Artefact Type | Result |
|-------|---------------|--------|
| 1 | log (6 elements) | PASS |
| 2 | digest (3 elements) | PASS |
| 3 | repos (6 elements) | PASS |
| 4 | contracts (3 elements) | PASS |
| 5 | decisions (3 elements) | PASS |
| 6 | orchestrator (3 elements) | PASS |
