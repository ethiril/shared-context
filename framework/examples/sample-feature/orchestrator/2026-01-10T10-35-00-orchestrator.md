...
- API enqueue path live on staging — `log/2026-01-10T09-30-00-api-shipped.dsl`.
...
- Wire contract published — `contracts/welcome-email-job/2026-01-10T09-00-00-api-v1.0.0.dsl`.
